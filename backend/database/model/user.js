          ...
          if (user.is_admin) {
            ...
            for (let i = 0; i < 10; i++) {
              text =
                text +
                'Pracovník číslo ' +
                dataToSend[i].karticka +
                ' ' +
                dataToSend[i].meno +
                ' ' +
                dataToSend[i].priezvisko +
                ', ktorý mal školenia ' +
                dataToSend[i].kod_skolenia +
                ' ' +
                new Date(dataToSend[i].datum_absolvovania).toLocaleDateString(
                  'sk-SK'
                ) +
                ' oblast:' +
                dataToSend[i].oblast +
            ...
            for (let i = 0; i < 10; i++) {
              text =
                text +
                'Pracovník číslo ' +
                readyData[i].karticka +
                ' ' +
                readyData[i].meno +
                ' ' +
                readyData[i].priezvisko +
                ', ktorý mal školenia ' +
                readyData[i].kod_skolenia +
                ' ' +
                new Date(readyData[i].datum_absolvovania).toLocaleDateString(
                  'sk-SK'
                ) +
                ' oblast:' +
                readyData[i].oblast +
